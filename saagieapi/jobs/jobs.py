...
class Jobs:
    ...
    def delete_instances_by_selector(
        ...
        params = {
            "jobId": job_id,
            "selector": selector,
            "excludeJobInstanceId": [] if exclude_instances_id is None else exclude_instances_id,
            "includeJobInstanceId": [] if include_instances_id is None else include_instances_id,
        }
    ...
    def count_instances_by_date(self, job_id: str, date_before: str):
        """Count job instances by date
    ...
    def generate_description_by_AI(self, job_id: str):
        ...
        # example : TransportQueryError: {'message': 'Job not valid', 'path': ['editJobWithAiGeneratedDescription'], 'extensions':
        # {'job.description': 'Job description is already generated', 'classification': 'ValidationError'}}
